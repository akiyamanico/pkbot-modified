               ...
               if msg.contentType == 0:
                    ...
                    if text is None:
                        ...
                        if cmd == "cek":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin or msg._from in staff:
                               dollypk.sendMessage(msg.to, "𝐁𝐄𝐍𝐓𝐀𝐑 𝐁𝐄𝐍𝐓𝐀𝐑 𝐋𝐎𝐀𝐃𝐈𝐍𝐆 𝐃𝐔𝐋𝐔\n❲███████▒▒▒▒▒▒▒❳ 20% \n❲████████▒▒▒▒▒▒❳ 40% \n❲█████████▒▒▒▒▒❳ 60% \n❲██████████▒▒▒▒❳ 80% \n❲████████████▒▒❳ 90% \n❲██████████████❳ 100%")
                               ...
                               dollypk.sendContact(to, "uca6d717f792fc3949dc9f6a1ab369bd0")
                               dollypk.sendMessage(msg.to, "Dahlah cape...bye - bye")
